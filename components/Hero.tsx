...
export const Hero = () => {
  return (
    <section
      id="hero"
      className="max-container padding-container flex-co xl:flex items-center xl:h-[calc(100vh-67px)] scroll-mt-[67px]"
    >
      <Image
        priority={true}
        src="/hero-image.avif"
      ...
      />
      <div className="text-black-90 xl:ml-[-35px] text-center xl:text-left px-[32px] py-[64px] xl:p-0">
