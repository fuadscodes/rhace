...
export const Hero = () => {
  return (
    <section className="max-container padding-container flex items-center h-[calc(100vh-67px)]">
      <Image src="/hero-image.avif" alt="motorcycle image" width="1400" height="300" priority={true} className="ml-[-480px] mb-[150px]" />
      <div className="text-black-90 md:ml-[-35px]">
        <h1 className="text-[40px] font-bold">SEARCH OR COMPARE</h1>
        <p className="w-[400px] text-[19px] font-light">
